...
export const MARKET_HOLIDAYS: Record<string, string> = {
  ...
  "2021-07-05": "Día de la Independencia (observado)",
  "2021-09-06": "Labor Day",
  "2021-11-25": "Thanksgiving",
  "2021-12-24": "Navidad (observado)",
  "2022-01-01": "Año Nuevo",
  "2022-01-17": "MLK Day",
  "2022-02-21": "Presidents Day",
  "2022-04-15": "Viernes Santo",
  "2022-05-30": "Memorial Day",
  "2022-06-20": "Juneteenth (observado)",
  ...
  "2023-07-04": "Día de la Independencia",
  ...
  "2024-07-04": "Día de la Independencia",
...
export function getMarketHoliday(dateStr: string): string | undefined {
  return MARKET_HOLIDAYS[dateStr]
}
